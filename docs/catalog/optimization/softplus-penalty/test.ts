/**
 * Responsibility:
 * Verify analytical derivatives for softplus penalty.
 */
...
const TEST_RANDOM_SEED = 67;
const TEST_SAMPLE_COUNT = 10;
const CENTRAL_DIFFERENCE_EPSILON = 1e-6;
const DIRECTION_VECTOR: GradientVector = [0.2, -0.3, 0.4];
const RELAXED_TOLERANCE: Tolerance = {
  absoluteTolerance: 4e-6,
  relativeTolerance: 4e-6,
};
